...
const char * const BITCOIN_CONF_FILENAME = "kriscoin.conf";
const char * const BITCOIN_PID_FILENAME = "kriscoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kriscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kriscoin";
#else
    // Unix
    return pathRet / ".kriscoin";
#endif
#endif
}
