...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kriscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kriscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kriscoin transaction") + "\n" +
              "  kriscoin-tx [options] -create [commands]   " + _("Create hex-encoded kriscoin transaction") + "\n" +
              "\n";
