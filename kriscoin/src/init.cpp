...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kriscoin-project/kriscoin>";
    const std::string URL_WEBSITE = "<https://kriscoin.org>";
